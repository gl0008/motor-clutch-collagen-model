...
% ======================================================================
\section{Positioning and lineage}
...
% ======================================================================
\section{The shared Generation-2 engine (unchanged)}
\label{sec:engine}
...
\subsection{Overdamped bead force balance}
...
\subsection{Freely-hinged permanent crosslinks}
...
\subsection{Soft cell-surface repulsion}
...
\subsection{Network generation and the percolation gate}
\label{sec:gen}
...
% ======================================================================
\section{The shared motor--clutch law}
\label{sec:clutch}
...
% ======================================================================
\section{What Generation-3 adds on top}
...
\subsection{A spheroid with a fibre-free gap}
\label{sec:gap}
...
\subsection{Explicit protrusions and tip-first engagement}
...
\subsection{Emergent polarity: wave-pinning + adhesion feedback}
\label{sec:polarity}
...
\subsection{FAK/Rac1 adhesion signal}
\label{sec:fak}
...
\subsection{Reaction-driven 2-D migration}
\label{sec:motion}
...
% ======================================================================
\section{Parameters and literature anchors}
\label{sec:params}
...
% ======================================================================
\section{Reference run and falsifiability}
\label{sec:results}
