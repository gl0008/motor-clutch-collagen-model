...
def main():
    ...
    runs = {
        "g3a": load_saved_run(results / "g3a_5nN"),
        "g3b_off": load_saved_run(results / "g3b_feedback_off_5nN"),
        "g3b_on": load_saved_run(results / "g3b_feedback_on_5nN"),
        "g3c_fixed": load_saved_run(results / "g3c_fixed_5nN"),
        "g3c_released": load_saved_run(results / "g3c_released_5nN"),
    }
