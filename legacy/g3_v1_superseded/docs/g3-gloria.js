(function(){
  ...
  const stages={
    g3a:{title:'G3A-R · protrusion-tip attachment and G2-scale loading',subtitle:'Both panels read the same solved 99-fibre trajectory. Zero attachment at t=0 is followed by growth, material-point capture, then a declared 5 nN traction ramp.',gif:'assets/g3_g2scale/g3a_g2scale_loading.gif',left:['Protrusion growth and attachment','g3a','mechanism'],right:['G2-scale fibre response','g3a','response'],view:'near',vectors:true,equation:'ζᵦ ṙᵢ = Fᵢˢᵗʳᵉᵗᶜʰ + Fᵢᵇᵉⁿᵈ + Fᵢˣˡⁱⁿᵏ + Fᵢᶜˡᵘᵗᶜʰ + Fᵢᶜᵒⁿᵗᵃᶜᵗ',what:'A green protrusion grows at finite speed, captures a continuous collagen material point, then a G2-equivalent 5 nN controlled traction ramp is applied. Red spokes identify bound clutches. Any arrow scaling is a labelled visual aid; metrics are true scale.'},
    g3b:{title:'G3B-R · cell-intrinsic polarity with G2-scale loading',subtitle:'The two panels use the same solved seed and aligned 99-fibre network with the same 5 nN post-attachment controlled traction.',gif:'assets/g3_g2scale/g3b_g2scale_feedback.gif',left:['Adhesion feedback OFF','g3b_off','standard'],right:['Adhesion feedback ON','g3b_on','standard'],view:'near',vectors:false,equation:'aₛⁿ⁺¹ = 𝒩₊[aₛⁿ + (Δt/τₐ)(Acell πₛ − aₛⁿ) + ηₛ],   Σₛaₛ = 1',what:'The activity pool is conserved and cell intrinsic; no collagen direction is supplied as polarity input. This short matched movie demonstrates the mechanism sequence, not feedback validation.'},
    g3c:{title:'G3C-R · fixed versus reaction-driven released cell',subtitle:'Both panels use the same solved polarity, clutch and 99-fibre ECM loop with 5 nN controlled traction after attachment.',gif:'assets/g3_g2scale/g3c_g2scale_released.gif',left:['Fixed cell','g3c_fixed','standard'],right:['Released cell','g3c_released','standard'],view:'full',vectors:false,equation:'ṙc = Fcell/ζc,   φ̇c = τcell/ζr,   Fcell = −Σc∈bound fc',what:'The fixed cell records force but cannot translate or rotate. The released cell updates x, y and body angle from the solved reaction force and torque. There is no prescribed velocity; metrics show true scale.'}
  };
